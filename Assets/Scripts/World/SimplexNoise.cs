...
public sealed class SimplexNoise
{
    ...
    private static readonly SimplexNoise instance = new SimplexNoise();

    public static SimplexNoise Instance
    {
        get
        {
            return instance;
    ...
    public float SimplexNoise2D(int x, int y, int n)
    {
        return SimplexNoise3D(x, y, 0, n);
    }

    public float SimplexNoise3D(int x, int y, int z, int n)
    {
        ...
        { //for each octave
            ...
            sum += noise(x, y, z) * scale; //add in an octave of noise
            x *= 2; y *= 2; //apply lacunarity
        }
    ...
    public static float noise(float xin, float yin)
    {
        ...
        int i = CMath.Floor(xin + s);
        int j = CMath.Floor(yin + s);
        ...
        {
            t0 *= t0;
            n0 = t0 * t0 * CMath.Dot(grad3[gi0], x0, y0); // (x,y) of grad3 used for 2D gradient
        }
        ...
        {
            t1 *= t1;
            n1 = t1 * t1 * CMath.Dot(grad3[gi1], x1, y1);
        }
        ...
        {
            t2 *= t2;
            n2 = t2 * t2 * CMath.Dot(grad3[gi2], x2, y2);
        }
    ...
    public static float noise(float xin, float yin, float zin)
    {
        ...
        {
            t0 *= t0;
            n0 = t0 * t0 * CMath.Dot(grad3[gi0], x0, y0, z0);
        }
        ...
        {
            t1 *= t1;
            n1 = t1 * t1 * CMath.Dot(grad3[gi1], x1, y1, z1);
        }
        ...
        {
            t2 *= t2;
            n2 = t2 * t2 * CMath.Dot(grad3[gi2], x2, y2, z2);
        }
        ...
        {
            t3 *= t3;
            n3 = t3 * t3 * CMath.Dot(grad3[gi3], x3, y3, z3);
        }
        // Add contributions from each corner to get the final noise value.
    ...
    float noise(float x, float y, float z, float w)
    {
        ...
        int i = CMath.Floor(x + s);
        int j = CMath.Floor(y + s);
        int k = CMath.Floor(z + s);
        int l = CMath.Floor(w + s);
        ...
        {
            t0 *= t0;
            n0 = t0 * t0 * CMath.Dot(grad4[gi0], x0, y0, z0, w0);
        }
        ...
        {
            t1 *= t1;
            n1 = t1 * t1 * CMath.Dot(grad4[gi1], x1, y1, z1, w1);
        }
        ...
        {
            t2 *= t2;
            n2 = t2 * t2 * CMath.Dot(grad4[gi2], x2, y2, z2, w2);
        }
        ...
        {
            t3 *= t3;
            n3 = t3 * t3 * CMath.Dot(grad4[gi3], x3, y3, z3, w3);
        }
        ...
        {
            t4 *= t4;
            n4 = t4 * t4 * CMath.Dot(grad4[gi4], x4, y4, z4, w4);
        }
